...
function c101010324.spptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(e:GetHandler():GetControler(),10006000)==0 end
end
function c101010324.sppop(e,tp,eg,ep,ev,re,r,rp)
	...
	if indigo==0 then
		Duel.RegisterFlagEffect(p,10006000,0,EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE,1)
		if red+orange+yellow+green+blue+1+purple==7 then
