...
function c101010012.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101010012.filter1,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c101010012.filter1,tp,LOCATION_GRAVE,0,1,1,nil)
...
function c101010012.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(c101010012.filter2,tp,LOCATION_MZONE,0,nil)
	local tc=g:GetFirst()
