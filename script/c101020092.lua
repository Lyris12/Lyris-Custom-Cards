...
function c101020092.initial_effect(c)
	...
	e3:SetTarget(c101020092.sptg)
	e3:SetOperation(c101020092.spop)
	c:RegisterEffect(e3)
end
function c101020092.sfilter(c,e,tp)
	return c:IsType(TYPE_XYZ) and c:IsRace(RACE_DRAGON) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c101020092.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
