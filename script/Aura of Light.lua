...
function c101010000.initial_effect(c)
	...
	e1:SetCondition(c101010000.condition1)
	e1:SetCost(c101010000.cost)
	e1:SetTarget(c101010000.target1)
	e1:SetOperation(c101010000.activate1)
	c:RegisterEffect(e1)
	--Activate(attack)
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_ACTIVATE)
	e2:SetDescription(aux.Stringid(101010000,1))
	e2:SetCategory(CATEGORY_DAMAGE+CATEGORY_DESTROY)
	e2:SetCode(EVENT_ATTACK_ANNOUNCE)
	e2:SetCondition(c101010000.condition2)
	e2:SetCost(c101010000.cost)
	e2:SetTarget(c101010000.target2)
	e2:SetOperation(c101010000.activate2)
	c:RegisterEffect(e2)
end
function c101010000.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010000.condition1(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev)
end
function c101010000.target1(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010000.activate1(e,tp,eg,ep,ev,re,r,rp)
...
function c101010000.condition2(e,tp,eg,ep,ev,re,r,rp)
	return tp~=Duel.GetTurnPlayer()
end
function c101010000.target2(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010000.activate2(e,tp,eg,ep,ev,re,r,rp)
	local tg=Duel.GetAttacker()
