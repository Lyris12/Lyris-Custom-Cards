...
function ref.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(ref.costfilter,tp,LOCATION_HAND,0,1,nil) end
...
function ref.cdop(e,tp,eg,ep,ev,re,r,rp)
