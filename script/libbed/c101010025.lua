...
function ref.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,ref.cfilter,tp,LOCATION_HAND,0,1,1,e:GetHandler())
...
function ref.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then
		...
		local g2=Duel.SelectMatchingCard(tp,ref.filter2,tp,LOCATION_REMOVED,0,1,1,nil)
