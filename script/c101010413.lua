...
function ref.initial_effect(c)
	aux.AddFusionProcFun2(c,ref.ffilter,aux.FilterBoolFunction(Card.IsSetCard,0x93),false)
	--special summon
...
function ref.op(e,tp,eg,ep,ev,re,r,rp)
	...
	e6:SetCondition(ref.rmcon)
	e6:SetTarget(ref.rmtg)
	e6:SetOperation(ref.rmop)
...
function ref.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(ref.cfilter,tp,LOCATION_GRAVE,0,1,nil)
	and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,true,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function ref.rspop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
