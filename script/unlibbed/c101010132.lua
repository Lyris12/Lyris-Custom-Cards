...
function c101010111.initial_effect(c)
	...
	e1:SetCondition(c101010111.spcon)
	e1:SetTarget(c101010111.sptg)
	e1:SetOperation(c101010111.spop)
	c:RegisterEffect(e1)
end
function c101010111.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer~=tp
end
function c101010111.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010111.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		...
		e3:SetOperation(c101010111.deslop)
		...
		e4:SetCondition(c101010111.deslcon)
		c:RegisterEffect(e4)
		...
		e5:SetCondition(c101010111.descon)
		e5:SetTarget(c101010111.destg)
		e5:SetOperation(c101010111.desop)
		c:RegisterEffect(e5)]]
	end
end
function c101010111.deslcon(e,tp,eg,ep,ev,re,r,rp)
	if rp==tp or not re:IsHasProperty(EFFECT_FLAG_CARD_TARGET) then return end
	local g=Duel.GetChainInfo(ev,CHAININFO_TARGET_CARDS)
	return g and g:IsContains(e:GetHandler())
end
function c101010111.deslop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
