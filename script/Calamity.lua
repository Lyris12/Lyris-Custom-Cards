...
function c101010249.initial_effect(c)
	...
	e1:SetTarget(c101010249.target1)
	e1:SetOperation(c101010249.operation1)
	c:RegisterEffect(e1)
	--atkup
	...
	e2:SetCondition(c101010249.condition2)
	e2:SetCost(c101010249.cost2)
	e2:SetOperation(c101010249.operation2)
	c:RegisterEffect(e2)
end
function c101010249.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHand() end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,e:GetHandler(),1,0,0)
end
function c101010249.operation1(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		Duel.SendtoHand(c,nil,REASON_EFFECT)
	end
end
function c101010249.condition2(e,tp,eg,ep,ev,re,r,rp)
...
function c101010249.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToDeckAsCost() end
	Duel.SendtoDeck(e:GetHandler(),nil,0,REASON_COST)
end
function c101010249.operation2(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetAttacker()
	local d=Duel.GetAttackTarget()
	...
	e2:SetOperation(c101010249.damop)
	Duel.RegisterEffect(e2,tp)
end
function c101010249.damop(e)
	local c=e:GetOwner()
