...
--pendulum summon
	...
	e1:SetCondition(c101010097.con)
	c:RegisterEffect(e1)
	--scale
	...
	e2:SetCondition(c101010097.slcon)
	e2:SetValue(6)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	...
	e6:SetCountLimit(1,101010097)
	e6:SetTarget(c101010097.tg)
	e6:SetOperation(c101010097.op)
	c:RegisterEffect(e6)
	--remove attribute
	...
	e5:SetTarget(c101010097.ratg)
	e5:SetValue(ATTRIBUTE_DARK)
	c:RegisterEffect(e5)
	--normal summon
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(101010097,0))
	e7:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e7:SetType(EFFECT_TYPE_SINGLE)
	e7:SetCode(EFFECT_SUMMON_PROC)
	e7:SetCondition(c101010097.otcon)
...
function c101010097.ratg(e)
	return e:GetHandler()
end
function c101010097.slcon(e)
	local seq=e:GetHandler():GetSequence()
	local tc=Duel.GetFieldCard(e:GetHandlerPlayer(),LOCATION_SZONE,13-seq)
	return not tc or (not tc:IsSetCard(0x306))
end
function c101010097.tg(e,tp,eg,ep,ev,re,r,rp,chk)
