...
--Activate
	...
	e0:SetTarget(c101010309.target)
	e0:SetOperation(c101010309.operation)
	c:RegisterEffect(e0)
...
function c101010309.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010309.operation(e,tp,eg,ep,ev,re,r,rp)
