...
function ref.atkcon(e)
	return (Duel.GetAttacker()==e:GetHandler() and Duel.GetAttackTarget()~=nil) and Duel.IsExistingMatchingCard(Card.IsCode,e:GetHandler():GetControler(),LOCATION_REMOVED,0,1,nil,id)
end
