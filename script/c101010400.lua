...
c101010400.altdesc=aux.Stringid(101010400,0)
c101010400.alterop= function(e,tp,chk)
						local rc=e:GetLabelObject()
						if chk==0 then return e: end
...
function c101010400.alfilter(c)
	return c:IsFaceup() and c101010400.alterf(c) and c:IsAbleToRemove()
end
