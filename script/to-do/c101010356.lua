...
local e1=Effect.CreateEffect(c)
	...
	--e1:SetCountLimit(1)
	e1:SetCost(c101010356.cost)
	e1:SetTarget(c101010356.tg)
	e1:SetOperation(c101010356.op)
	c:RegisterEffect(e1)
end
function c101010356.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010356.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010356.op(e,tp,eg,ep,ev,re,r,rp)
