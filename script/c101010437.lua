...
function ref.start(c)
	...
	e2:SetTarget(ref.sptarget)
	e2:SetOperation(ref.spoperation)
	c:RegisterEffect(e2)
	--second effect
...
function ref.sptarget(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function ref.spoperation(e,tp,eg,ep,ev,re,r,rp)
