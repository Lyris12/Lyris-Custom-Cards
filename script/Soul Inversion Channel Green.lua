...
function c101010261.initial_effect(c)
	...
	e1:SetOperation(c101010261.op)
	c:RegisterEffect(e1)
end
c101010261.global_check=false
function c101010261.op(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c101010261.global_check then return end
	c101010261.global_check=true
	...
	while tc do
		if not tc:IsSetCard(0xe9) then
			if bit.band(tc:GetType(),0x11)==0x11 then
				...
				e2:SetOperation(c101010261.atklimit)
...
function c101010261.atklimit(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
