...
function c101010427.initial_effect(c)
	...
	e0:SetTarget(c101010427.target)
	e0:SetOperation(c101010427.operation)
	c:RegisterEffect(e0)
	...
	e2:SetTarget(c101010427.sptarget)
	e2:SetOperation(c101010427.spoperation)
	c:RegisterEffect(e2)
	--second effect
	...
	e3:SetTarget(c101010427.destg)
	e3:SetOperation(c101010427.desop)
	c:RegisterEffect(e3)
end
function c101010427.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010427.operation(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.GetFirstTarget()
	if e:GetHandler():IsRelateToEffect(e) and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		Duel.Equip(tp,e:GetHandler(),tc)
	end
end
function c101010427.sptarget(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010427.spoperation(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) then
		...
		e1:SetValue(c101010427.eqlimit)
		e1:SetLabelObject(tc)
		c:RegisterEffect(e1)
	end
end
function c101010427.eqlimit(e,c)
	return e:GetLabelObject()==c
end
function c101010427.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
...
function c101010427.desop(e,tp,eg,ep,ev,re,r,rp)
