...
function c101010215.initial_effect(c)
	...
	e1:SetTarget(c101010215.spptg)
	e1:SetOperation(c101010215.sppop)
	c:RegisterEffect(e1)
end
function c101010215.spptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(e:GetHandler():GetControler(),10001000)==0 end
end
function c101010215.sppop(e,tp,eg,ep,ev,re,r,rp)
	...
	if red==0 then
		Duel.RegisterFlagEffect(p,10001000,0,EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE,1)
		if 1+orange+yellow+green+blue+indigo+purple==7 then
