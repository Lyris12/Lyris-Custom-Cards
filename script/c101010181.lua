...
function c101010181.initial_effect(c)
	...
	e2:SetCondition(c101010181.spcon)
	e2:SetTarget(c101010181.sumtg)
	e2:SetOperation(c101010181.sumop)
	c:RegisterEffect(e2)
end
function c101010181.cfilter(c)
	return c:IsType(TYPE_MONSTER) and not c:IsPublic()
end
function c101010181.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c101010181.cfilter,1,nil) and not eg:IsExists(Card.IsControler,1,nil,1-eg:GetFirst():GetControler())
end
...
function c101010181.filter(c,e,tp)
...
function c101010181.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ap=eg:GetFirst():GetControler()
	local sg=Duel.GetMatchingGroup(c101010181.filter,p,LOCATION_DECK,0,nil,e,ap)
