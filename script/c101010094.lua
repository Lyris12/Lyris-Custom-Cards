...
local e1=Effect.CreateEffect(c)
	...
	e1:SetTarget(c101010094.tg)
	e1:SetOperation(c101010094.op)
	c:RegisterEffect(e1)
end
function c101010094.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010094.op(e,tp,eg,ep,ev,re,r,rp)
