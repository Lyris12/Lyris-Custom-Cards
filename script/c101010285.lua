...
function c101010285.initial_effect(c)
	...
	e1:SetTarget(c101010285.spptg)
	e1:SetOperation(c101010285.sppop)
	c:RegisterEffect(e1)
end
function c101010285.spptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(e:GetHandler():GetControler(),10002000)==0 end
end
function c101010285.sppop(e,tp,eg,ep,ev,re,r,rp)
	...
	if orange==0 then
		Duel.RegisterFlagEffect(p,10002000,0,EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE,1)
		if red+1+yellow+green+blue+indigo+purple==7 then
