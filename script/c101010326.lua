...
function c101010324.spptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFlagEffect(e:GetHandler():GetControler(),10005000)==0 end
end
function c101010324.sppop(e,tp,eg,ep,ev,re,r,rp)
	...
	if blue==0 then
		Duel.RegisterFlagEffect(p,10005000,0,EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE,1)
		if red+orange+yellow+green+1+indigo+purple==7 then
