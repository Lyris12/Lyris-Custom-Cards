...
function ref.thfilter(c)
	return c:IsSetCard(0xa88) and c:IsType(TYPE_MONSTER) and c:GetCode()~=id and c:IsAbleToHand()
end
...
function ref.sumsuc(e,tp,eg,ep,ev,re,r,rp)
