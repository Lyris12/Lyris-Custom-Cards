...
function c101010033.initial_effect(c)
	...
	e1:SetCondition(c101010033.atkcon)
	e1:SetValue(400)
	c:RegisterEffect(e1)
	--change code
	...
	e2:SetCountLimit(1,101010033)
	e2:SetCost(c101010033.cost)
	e2:SetOperation(c101010033.cdop)
	c:RegisterEffect(e2)
	--code
...
function c101010033.atkcon(e)
	local phase=Duel.GetCurrentPhase()
	return (phase==PHASE_DAMAGE or phase==PHASE_DAMAGE_CAL)
	and Duel.GetAttacker()==e:GetHandler()
end
function c101010033.costfilter(c)
	return c:IsType(TYPE_SPELL) and not c:IsPublic()
end
function c101010033.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101010033.costfilter,tp,LOCATION_HAND,0,1,nil) end
...
function c101010033.cdop(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetOperation(c101010033.actop)
	e2:SetLabelObject(e:GetLabelObject())
	e2:SetReset(RESET_EVENT+0x1fe0000)
	c:RegisterEffect(e2)
end
function c101010033.actop(e,tp,eg,ep,ev,re,r,rp)
