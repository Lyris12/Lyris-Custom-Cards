...
function c101010155.initial_effect(c)
	...
	e2:SetCondition(c101010155.spcon)
	c:RegisterEffect(e2)
end
function c101010155.filter(c)
	return c:IsFaceup() and c:IsSetCard(0x5cd)
end
function c101010155.con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c101010155.filter,tp,LOCATION_MZONE,0,1,e:GetHandler()) and e:GetHandler():IsLevelAbove(1)
end
function c101010155.op(e,tp,eg,ep,ev,re,r,rp)
