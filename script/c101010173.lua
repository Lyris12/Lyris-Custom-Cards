...
function c101010173.filter(c,e,tp)
	return c.spatial and c:IsCanBeSpecialSummoned(e,0x4000,tp,false,false)
end
...
function c101010173.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if sg:GetCount()>0 then
		...
		mc:Merge(ms)
		tc:SetMaterial(mc)
		Duel.SendtoGrave(mc,REASON_EFFECT+REASON_MATERIAL+0x40000000000)
		Duel.BreakEffect()
		Duel.SpecialSummon(tc,0x4000,tp,tp,false,false,POS_FACEUP)
