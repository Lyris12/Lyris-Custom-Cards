...
function c101010104.cfilter(c)
	return c:IsReleasableByEffect() and (c:IsLevelBelow(6) or c101010104.star(c))
end
...
function c101010104.actcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=nil
	if not cg:CheckWithSumEqual(Card.GetLevel,12,1,99) or (cg:IsExists(c101010104.star,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(101010187,0))) then
