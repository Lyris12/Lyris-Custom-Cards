...
function c101010340.initial_effect(c)
	...
	e3:SetValue(c101010340.splimit)
	c:RegisterEffect(e3)
	--extra att
	...
	e5:SetCondition(c101010340.descon)
	e5:SetTarget(c101010340.destg)
	e5:SetOperation(c101010340.desop)
	c:RegisterEffect(e5)
end
function c101010340.splimit(e,se,sp,st)
	return st==SUMMON_TYPE_FUSION+0xFA0
end
function c101010340.descon(e,tp,eg,ep,ev,re,r,rp)
	return ep~=tp
end
function c101010340.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010340.desop(e,tp,eg,ep,ev,re,r,rp)
