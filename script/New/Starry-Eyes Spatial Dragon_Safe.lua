...
function c101010253.initial_effect(c)
	...
	e1:SetCondition(c101010253.spcon)
	e1:SetOperation(c101010253.spop)
...
function c101010253.spfilter(c,v,y,z)
	local atk=c:GetAttack()
	return c:GetLevel()==v and atk>=y and atk<=z and c:IsAbleToRemoveAsCost()
end
function c101010253.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and Duel.IsExistingMatchingCard(c101010253.spfilter,tp,LOCATION_MZONE,0,1,nil,4,1050,1750)
end
function c101010253.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.SelectMatchingCard(tp,c101010253.spfilter,tp,LOCATION_MZONE,0,1,1,nil,4,1050,1750)
