...
function c101010479.initial_effect(c)
	...
	e2:SetTarget(c101010479.postg)
	e2:SetOperation(c101010479.posop)
	c:RegisterEffect(e2)
end
function c101010479.atkfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xbb2)
end
function c101010479.val(e,c)
	return Duel.GetMatchingGroupCount(c101010479.atkfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,c)*100
end
function c101010479.postg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c101010479.posop(e,tp,eg,ep,ev,re,r,rp)
