...
function c101010257.initial_effect(c)
	...
	ae1:SetValue(c101010257.slimit)
	...
	ae2:SetTarget(c101010257.atcon)
	...
	ae3:SetCondition(c101010257.condition)
	ae3:SetTarget(c101010257.dtarget)
	ae3:SetValue(c101010257.adval)
	...
	ae4:SetCondition(c101010257.condition)
	ae4:SetTarget(c101010257.dtarget)
	ae4:SetValue(c101010257.ddval)
	...
	ae5:SetOperation(c101010257.regop)
...
function c101010257.spfilter(c,v,y,z)
...
function c101010257.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and Duel.IsExistingMatchingCard(c101010257.spfilter,tp,LOCATION_MZONE,0,1,nil,4,2100,2700)
end
function c101010257.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local g=Duel.GetMatchingGroup(c101010257.spfilter,tp,LOCATION_MZONE,0,nil)
...
function c101010257.atcon(e,c)
	return c==e:GetHandler()
end
function c101010257.slimit(e,se,sp,st)
	return bit.band(st,0x7150)==0x7150
end
function c101010257.condition(e)
	return bit.band(e:GetHandler():GetSummonType(),0x7150)==0x7150
end
function c101010257.dtarget(e,c)
	return c:IsFaceup() and not c:IsRace(RACE_DRAGON+RACE_WYRM)
end
function c101010257.adval(e,c)
	return -c:GetBaseAttack()/4
end
function c101010257.ddval(e,c)
	return -c:GetBaseDefence()/4
end
function c101010257.regop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(201010257)==0 then
		...
		e1:SetCondition(c101010257.con)
		e1:SetOperation(c101010257.desop)
		...
		e3:SetCondition(c101010257.con)
		e3:SetTarget(c101010257.efilter)
...
function c101010257.con(e)
	return e:GetHandler():GetEquipCount()>0
end
function c101010257.desfilter(c)
	return c:IsFaceup() and c:IsType(TYPE_CONTINUOUS)
end
function c101010257.desop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=Duel.GetFieldGroup(tp,LOCATION_ONFIELD,LOCATION_ONFIELD)
	local tc=g:GetFirst()
	while tc do
		if c101010257.desfilter(tc) then
			Duel.Remove(tc,POS_FACEUP,REASON_EFFECT)
		end
		tc=g:GetNext()
	end
end
function c101010257.efilter(e,c)
