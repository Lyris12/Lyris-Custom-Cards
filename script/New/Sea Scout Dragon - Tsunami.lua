...
function c101010204.initial_effect(c)
	...
	e1:SetValue(c101010204.aclimit)
	e1:SetCondition(c101010204.actcon)
	c:RegisterEffect(e1)
	...
	e3:SetCondition(c101010204.con)
	e3:SetTarget(c101010204.tg)
	e3:SetOperation(c101010204.op)
	c:RegisterEffect(e3)
	if not c101010204.global_check then
		c101010204.global_check=true
		local ge1=Effect.CreateEffect(c)
		ge1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge1:SetCode(EVENT_ATTACK_ANNOUNCE)
		ge1:SetOperation(c101010204.checkop)
		Duel.RegisterEffect(ge1,0)
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ATTACK_DISABLED)
		ge2:SetOperation(c101010204.check2)
		Duel.RegisterEffect(ge2,0)
		ge2:SetLabelObject(ge1)
		e3:SetLabelObject(ge1)
	end
end
function c101010204.aclimit(e,re,tp)
	local c=re:GetHandler()
	return c:IsType(TYPE_SPELL+TYPE_TRAP) and not c:IsImmuneToEffect(e)
end
function c101010204.actcon(e)
	return Duel.GetAttacker()==e:GetHandler()
end
--[[function c101010204.fatg(e,c)
	return c~=e:GetHandler() and c:IsAttackable()
end
function c101010204.condition(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetFieldGroup(tp,LOCATION_MZONE,0)
	return g:IsExists(Card.IsAttackable,1,nil)
end]]
function c101010204.checkop(e,tp,eg,ep,ev,re,r,rp)
...
function c101010204.check2(e,tp,eg,ep,ev,re,r,rp)
	local tc=eg:GetFirst()
...
function c101010204.con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and e:GetLabelObject():GetLabel()>2
end
function c101010204.tg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010204.op(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
