...
c:EnableCounterPermit(0x3001)
	...
	e1:SetTarget(c101010100.destg)
	e1:SetOperation(c101010100.desop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
	...
	e2:SetValue(c101010100.attackup)
	c:RegisterEffect(e2)
end
function c101010100.ratg(e)
	return e:GetHandler()
end
...
function c101010100.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetMatchingGroupCount(c101010100.chkfilter,tp,LOCATION_MZONE,LOCATION_MZONE,nil)>0
	...
	local g=Duel.SelectTarget(tp,c101010100.desfilter,tp,0,LOCATION_ONFIELD,1,ct,nil)
