...
function c101010614.initial_effect(c)
	...
	e0:SetTarget(c101010614.drtg)
	e0:SetOperation(c101010614.drop)
	c:RegisterEffect(e0)
end
function c101010614.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101010614.drop(e,tp,eg,ep,ev,re,r,rp)
