...
--to hand
	...
	e2:SetCondition(c101010017.condition2)
	e2:SetCost(c101010017.cost2)
	e2:SetOperation(c101010017.operation2)
	c:RegisterEffect(e2)
end
function c101010017.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHand() end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,e:GetHandler(),1,0,0)
end
function c101010017.operation1(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		Duel.SendtoHand(c,nil,REASON_EFFECT)
	end
end
function c101010017.condition2(e,tp,eg,ep,ev,re,r,rp)
