...
function c101010474.initial_effect(c)
	...
	c:RegisterEffect(e2)
	--If this card is Special Summoned from the Graveyard after being sent there from the field: You can Set 1 "Monument" monster from your Deck to your Spell & Trap Zone as a Trap Card. You can only use this effect of "Monument Goldenrod" once per turn.
